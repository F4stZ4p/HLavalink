...
class LavalinkBootstrap:
    ...
    def __init__(self):
        ...
        self.download_command = f"curl -L https://github.com/natanbc/andesite/releases/download/0.18.9/andesite-node-0.18.9-all.jar -o Lavalink.jar" if self.use_dev_lavalink else f"curl -L https://github.com/Frederikam/Lavalink/releases/download/{self._version_number}/Lavalink.jar -O"
